...
task :process do
  sh "build-Release/bin/frame_stats --start-at 5000 --stop-at 6000 -o CAMHDA301-20160101T000000Z.json --stride 10 -- /RS03ASHS/PN03B/06-CAMHDA301/2016/01/01/CAMHDA301-20160101T000000Z.mov
"
end
